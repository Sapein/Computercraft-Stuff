-- Random Program 1 By Sapein with a bit of help from tayler6000
-- V 0.3
...
elseif x == '1' then -- Checks to see if they selected Menu
    ...
    elseif x == '3' then --if the third option is selected
		...
		print('You did not enter a valid number, please return to menu.')  --I would make this return for them but you did not program it to do that.
    end --ends the if statement
else
	print('You did not enter a valid number.')--I put these in just in case you never know when someone presses the wrong button.
end -- ends the if statement
-- I would have done more but i dont know what else you want me to do...
